...
-- not yet available in the stable version of PostgreSQL
...
FROM object
JOIN pg_foreign_data_wrapper ON (object.classoid = 'pg_foreign_data_wrapper'::regclass AND pg_foreign_data_wrapper.oid = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_authid               ON (object.classoid = 'pg_authid'::regclass               AND pg_authid.oid               = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_foreign_server       ON (object.classoid = 'pg_foreign_server'::regclass       AND pg_foreign_server.oid       = object.objoid)
UNION ALL
SELECT
pg_am.amname,
NULL,
...
NULL
FROM object
JOIN pg_am                   ON (object.classoid = 'pg_am'::regclass                   AND pg_am.oid                   = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_namespace            ON (object.classoid = 'pg_namespace'::regclass            AND pg_namespace.oid            = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_tablespace           ON (object.classoid = 'pg_tablespace'::regclass           AND pg_tablespace.oid           = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_user_mapping         ON (object.classoid = 'pg_user_mapping'::regclass AND pg_user_mapping.oid   = object.objoid)
JOIN pg_authid               ON (object.classoid = 'pg_user_mapping'::regclass AND pg_authid.oid         = pg_user_mapping.umuser)
JOIN pg_foreign_server       ON (object.classoid = 'pg_user_mapping'::regclass AND pg_foreign_server.oid = pg_user_mapping.umserver)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_conversion ON (object.classoid = 'pg_conversion'::regclass AND pg_conversion.oid = object.objoid)
JOIN pg_namespace  ON (object.classoid = 'pg_conversion'::regclass AND pg_namespace.oid  = pg_conversion.connamespace)
UNION ALL
SELECT
pg_am.amname,
NULL,
...
NULL
FROM object
JOIN pg_opclass   ON (object.classoid = 'pg_opclass'::regclass AND pg_opclass.oid   = object.objoid)
JOIN pg_am        ON (object.classoid = 'pg_opclass'::regclass AND pg_am.oid        = pg_opclass.opcmethod)
JOIN pg_namespace ON (object.classoid = 'pg_opclass'::regclass AND pg_namespace.oid = pg_opclass.opcnamespace)
UNION ALL
SELECT
pg_am.amname,
NULL,
...
NULL
FROM object
JOIN pg_opfamily  ON (object.classoid = 'pg_opfamily'::regclass AND pg_opfamily.oid  = object.objoid)
JOIN pg_am        ON (object.classoid = 'pg_opfamily'::regclass AND pg_am.oid        = pg_opfamily.opfmethod)
JOIN pg_namespace ON (object.classoid = 'pg_opfamily'::regclass AND pg_namespace.oid = pg_opfamily.opfnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_type      ON (object.classoid = 'pg_type'::regclass AND pg_type.oid      = object.objoid)
JOIN pg_namespace ON (object.classoid = 'pg_type'::regclass AND pg_namespace.oid = pg_type.typnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_enum      ON (object.classoid = 'pg_enum'::regclass AND pg_enum.oid      = object.objoid)
JOIN pg_type      ON (object.classoid = 'pg_enum'::regclass AND pg_type.oid      = pg_enum.enumtypid)
JOIN pg_namespace ON (object.classoid = 'pg_enum'::regclass AND pg_namespace.oid = pg_type.typnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_cast ON (object.classoid = 'pg_cast'::regclass AND pg_cast.oid = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_operator  ON (object.classoid = 'pg_operator'::regclass AND pg_operator.oid  = object.objoid)
JOIN pg_namespace ON (object.classoid = 'pg_operator'::regclass AND pg_namespace.oid = pg_operator.oprnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_language ON (object.classoid = 'pg_language'::regclass AND pg_language.oid = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_proc      ON (object.classoid = 'pg_proc'::regclass AND pg_proc.oid      = object.objoid)
JOIN pg_namespace ON (object.classoid = 'pg_proc'::regclass AND pg_namespace.oid = pg_proc.pronamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_ts_config ON (object.classoid = 'pg_ts_config'::regclass AND pg_ts_config.oid = object.objoid)
JOIN pg_namespace ON (object.classoid = 'pg_ts_config'::regclass AND pg_namespace.oid = pg_ts_config.cfgnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_ts_dict   ON (object.classoid = 'pg_ts_dict'::regclass AND pg_ts_dict.oid   = object.objoid)
JOIN pg_namespace ON (object.classoid = 'pg_ts_dict'::regclass AND pg_namespace.oid = pg_ts_dict.dictnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_ts_parser ON (object.classoid = 'pg_ts_parser'::regclass AND pg_ts_parser.oid = object.objoid)
JOIN pg_namespace ON (object.classoid = 'pg_ts_parser'::regclass AND pg_namespace.oid = pg_ts_parser.prsnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
FROM object
JOIN pg_ts_template ON (object.classoid = 'pg_ts_template'::regclass AND pg_ts_template.oid = object.objoid)
JOIN pg_namespace   ON (object.classoid = 'pg_ts_template'::regclass AND pg_namespace.oid   = pg_ts_template.tmplnamespace)
UNION ALL
SELECT
pg_am.amname,
...
NULL
FROM object
JOIN pg_amop                             ON (object.classoid = 'pg_amop'::regclass AND pg_amop.oid      = object.objoid)
JOIN pg_opfamily                         ON (object.classoid = 'pg_amop'::regclass AND pg_opfamily.oid  = pg_amop.amopfamily)
JOIN pg_am                               ON (object.classoid = 'pg_amop'::regclass AND pg_am.oid        = pg_opfamily.opfmethod)
JOIN pg_operator                         ON (object.classoid = 'pg_amop'::regclass AND pg_operator.oid  = pg_amop.amopopr)
JOIN pg_namespace                        ON (object.classoid = 'pg_amop'::regclass AND pg_namespace.oid = pg_operator.oprnamespace AND pg_namespace.oid = pg_opfamily.opfnamespace)
UNION ALL
SELECT
pg_am.amname,
NULL,
...
NULL
FROM object
JOIN pg_amproc               ON (object.classoid = 'pg_amproc'::regclass AND pg_amproc.oid               = object.objoid)
JOIN pg_opfamily             ON (object.classoid = 'pg_amproc'::regclass AND pg_opfamily.oid             = pg_amproc.amprocfamily)
JOIN pg_am                   ON (object.classoid = 'pg_amproc'::regclass AND pg_am.oid                   = pg_opfamily.opfmethod)
JOIN pg_namespace            ON (object.classoid = 'pg_amproc'::regclass AND pg_namespace.oid            = pg_opfamily.opfnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_database ON (object.classoid = 'pg_database'::regclass AND pg_database.oid = object.objoid)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_rewrite   ON (object.classoid = 'pg_rewrite'::regclass AND pg_rewrite.oid   = object.objoid)
JOIN pg_class     ON (object.classoid = 'pg_rewrite'::regclass AND pg_class.oid     = pg_rewrite.ev_class)
JOIN pg_namespace ON (object.classoid = 'pg_rewrite'::regclass AND pg_namespace.oid = pg_class.relnamespace)
UNION ALL
SELECT
NULL,
NULL,
...
NULL
FROM object
JOIN pg_trigger   ON (object.classoid = 'pg_trigger'::regclass AND pg_trigger.oid   = object.objoid)
JOIN pg_class     ON (object.classoid = 'pg_trigger'::regclass AND pg_class.oid     = pg_trigger.tgrelid)
JOIN pg_namespace ON (object.classoid = 'pg_trigger'::regclass AND pg_namespace.oid = pg_class.relnamespace)
),
