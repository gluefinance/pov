CREATE OR REPLACE VIEW pov.View_Constraints AS
SELECT
...
FROM pov.View_Functions
INNER JOIN pg_catalog.pg_depend     ON (pg_catalog.pg_depend.refobjid = pov.View_Functions.oid)
