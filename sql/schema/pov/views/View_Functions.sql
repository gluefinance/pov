CREATE OR REPLACE VIEW pov.View_Functions AS
SELECT
...
-- Do not include pg_catalog, information_schema, or our own schema "pov"
...
-- Do not include the pov API-functions in the selection
AND (pg_catalog.pg_namespace.nspname <> 'public' OR pg_catalog.pg_proc.proname <> 'pov')
;
